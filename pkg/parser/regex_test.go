...
func TestTODOs(t *testing.T) {
	tcs := []struct {
		...
		{"// todo hello world", slashRegex, &issue.Issue{Title: "hello world", Mentions: []string{}, Labels: []string{}, Ctx: context.Background()}},
		...
		{"# todo(snake): impl python", hashRegex, &issue.Issue{Title: "impl python", Assignee: "snake", Mentions: []string{}, Labels: []string{}, Ctx: context.Background()}},
		{"# todo(snake) impl python", hashRegex, &issue.Issue{Title: "impl python", Assignee: "snake", Mentions: []string{}, Labels: []string{}, Ctx: context.Background()}},
		{`// fmt.Println("uh oh") todo(snake): eol comment`, slashRegex, &issue.Issue{Title: "eol comment", Assignee: "snake", Mentions: []string{}, Labels: []string{}, Ctx: context.Background()}},
		...
		{`	Ctx         context.Context // todo change Issue.Ctx from Context to map`, slashRegex, &issue.Issue{}}, //8
	}
